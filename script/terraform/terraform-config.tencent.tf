...
output "options" {
  value = {
    ...
    k8s_preload_images: [ "public.ecr.aws/metakube/calico/cni:v3.27.3", "public.ecr.aws/metakube/calico/node:v3.27.3", "public.ecr.aws/metakube/calico/kube-controllers:v3.27.3" ]
