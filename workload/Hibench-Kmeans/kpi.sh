...
awk -F \("-numClusters "\|" -numSamples"\|" -samplesPerFile"\|" -sampleDimension"\) '
/numClusters|numSamples|samplesPerFile|sampleDimension/{
    print "## HIBENCH_KMEANS_NUM_OF_CLUSTERS: " $2
    print "## HIBENCH_KMEANS_NUM_OF_SAMPLES: " $3
    print "## HIBENCH_KMEANS_SAMPLES_PER_INPUTFILE: " $4
    print "## HIBENCH_KMEANS_DIMENSIONS: " $5
