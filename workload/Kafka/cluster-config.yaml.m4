...
')
ifelse(index(TESTCASE,_multinode),-1,,`loop(`i', `1', eval(PRODUCER_NODE_NUM+CONSUMER_NODE_NUM), `dnl
- labels: {}
  vm_group: client
')')
ifelse(index(TESTCASE,_multinode),-1,,`loop(`i', `1', BROKER_SERVER_NUM, `dnl
