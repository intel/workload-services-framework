...
PLATFORM1=${PLATFORM1:-icelake-server}
COMPILER=${COMPILER:-gcc12.1.0-lin}
RELEASE1=${RELEASE1:-20220509}
TUNE=${TUNE:-base}
NUMA1=$NUMA
speccpu_config_file=
...
OPTIONS="--define default-platform-flags --define cores=$c --define $b --define smt-on --tune $TUNE -o all --define drop_caches --output_format=all --size ref -I $OPTIONS"
