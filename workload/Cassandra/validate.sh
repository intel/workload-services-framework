...
WORKLOAD_PARAMS=(
    ...
    NUMA_OPTIONS CLIENT_POP_MAX_PERFORMANCE_DIV SERVER_POD_NUM HOST_NUM 
    RAM_DISK_EANBLE KERNEL_TUNE_ENABLE CASSANDRA_NUMACTL_VCORES_ENABLE 
    CORE_FREQUENCY_ENABLE CORE_FREQUENCY UNCORE_FREQUENCY_ENABLE UNCORE_FREQUENCY
...
RECONFIG_OPTIONS="-DCLIENT_DURATION=${CLIENT_DURATION} -DCLIENT_CL=${CLIENT_CL} -DCLIENT_THREADS=${CLIENT_THREADS} -DCLIENT_INSERT=${CLIENT_INSERT} \
    ...
    -DCASSANDRA_NUMACTL_VCORES_ENABLE=${CASSANDRA_NUMACTL_VCORES_ENABLE} -DCORE_FREQUENCY_ENABLE=${CORE_FREQUENCY_ENABLE} -DCORE_FREQUENCY=${CORE_FREQUENCY} \
    -DUNCORE_FREQUENCY_ENABLE=${UNCORE_FREQUENCY_ENABLE} -DUNCORE_FREQUENCY=${UNCORE_FREQUENCY}"
