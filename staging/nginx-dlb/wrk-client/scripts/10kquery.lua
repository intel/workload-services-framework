...
-- hostname =string.gsub(hostname, "\n$", "")
 hostname = ""
-- path = "/_10kobject?version=" .. hostname .. param_value .. "&thread=" .. id
-- path = "/_10kobject?version=" .. param_value
-- path = "/_10kobject?version=" .. param_value
 path = "/_10kobject?version=" .. hostname .. param_value
-- path = "/_10kobjectVIDEO?version=" .. param_value
